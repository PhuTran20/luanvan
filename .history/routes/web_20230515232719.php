...
Route::get('/quanli_thuonghieu', function () {
    return view('quanli_thuonghieu');
})->name('quanli_thuonghieu');

//Thuonghieu
Route::get('/quanli_thuonghieu', [ThuongHieuController::class, 'all_ThuongHieu'])->name('quangli_thuonghieu');

...
Route::get('/trangchu', [ThuongHieuController::class, 'index'])->name('index');
...
// Route::get('/shop', [LoaiGiayController::class, 'indexshop'])->name('shop');
// Route::get('/detail', [LoaiGiayController::class, 'indexdetail'])->name('detail');
// Route::get('/cart', [LoaiGiayController::class, 'indexcart'])->name('cart');
// Route::get('/checkout', [LoaiGiayController::class, 'indexcheckout'])->name('checkout');
// Route::get('/contact', [LoaiGiayController::class, 'indexcontact'])->name('contact');

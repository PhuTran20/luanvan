            ...
            <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0"
                ...
                <div class="navbar-nav w-100 overflow-hidden"   >                                                                                              
                    <div class="nav-item dropdown">
                        <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0" style="z-index: 1000;">
                            @foreach ( $Loaigiay   as $data)
                            <a href="" class="dropdown-item">{{ $data->name_category }}</a>
                            @endforeach
                        </div>
                        <a href="#" class="nav-link   " data-toggle="dropdown">{{ $data->tenthuonghieu }} <i class="fa fa-angle-down float-right mt-1"></i></a>

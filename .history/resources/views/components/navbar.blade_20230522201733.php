        ...
        <div class="col-lg-3 d-none d-lg-block">
            ...
            <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0"
                ...
                <div class="navbar-nav w-100 overflow-hidden"  style="height: 410px">    
                    @foreach ( $Thuonghieu   as $dataa)                                                                                            
                    <div class="nav-item dropdown">
                         
                        <a href="#" class="nav-link   " data-toggle="dropdown">{{ $dataa->tenthuonghieu }} <i class="fa fa-angle-down float-right mt-1"></i></a>
                         
                         
                        <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0" style="z-index: 3;">
                            @foreach ( $Loaigiay   as $data)
                                @if( $dataa->tenthuonghieu == $data->tenthuonghieu )
                            <a href="" class="dropdown-item">{{ $data->name_category }}</a>
                            @endif
                            @endforeach
                        </div>

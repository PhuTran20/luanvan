...
<div class="container">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <form method="post" action="{{URL::to('/update-LoaiGiay')}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="idloaigiay" value="{{$edit_value->idloaigiay}} " hidden="true">

                    <input required="true" type="text" class="form-control" id=" " name="name_category"
                        value="{{$edit_value->name_category}} ">
                </div>

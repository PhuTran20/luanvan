        ...
        <div class="panel-body">
            ...
            <form method="post" action="{{URL::to('/save-ThuongHieu')}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="idthuonghieu" value="{{$edit_value->IDTheLoai}} " hidden="true">

                    <input required="true" type="text" class="form-control" id=" " name="tenthuonghieu" value="{{$edit_value->TenTheLoai}} ">
                </div>

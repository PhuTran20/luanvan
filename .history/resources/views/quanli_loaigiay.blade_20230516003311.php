...
@section('admin')
        <div class="content">
            ...
            ?>
                            <div class="card-body">
                                <a href="{{URL::to('add-LoaiGiay') }}">
                                    <button class="btn btn-success" style="margin-bottom: 15px;">Thêm Loại Giày</button>
                                </a>
                                ...
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        @foreach($all_LoaiGiay as $key => $LoaiGiay)
                    <tr>
                        <td>{{$LoaiGiay->idloaigiay}} </td>
                        <td>{{$LoaiGiay->tenthuonghieu}} </td>
                        <td>{{$LoaiGiay->name_category}} </td>
                        {{-- <td width="50px">
                            <a href="{{URL::to('/edit-ThuongHieu/'.$ThuongHieu->idthuonghieu)}}"><button
                                    class="btn btn-warning">Sửa</button></a>
                        </td>
                        <td width="50px">
                            <a href="{{URL::to('/delete-ThuongHieu/'.$ThuongHieu->idthuonghieu)}}"><button

...
class LoaiGiayController extends Controller
{
    public function indexx(){
        ...
        return view('index',['LoaiGiay'=>$LoaiGiay]);
    }
    // public function indexshop(){
    //     $LoaiGiay = LoaiGiay::all();
    //     return view('shop',['LoaiGiay'=>$LoaiGiay]);
    // }
    // public function indexcart(){
    //     $LoaiGiay = LoaiGiay::all();
    //     return view('cart',['LoaiGiay'=>$LoaiGiay]);
    // }
    // public function indexdetail(){
    //     $LoaiGiay = LoaiGiay::all();
    //     return view('detail',['LoaiGiay'=>$LoaiGiay]);
    // }
    // public function indexcontact(){
    //     $LoaiGiay = LoaiGiay::all();
    //     return view('contact',['LoaiGiay'=>$LoaiGiay]);
    // }
    // public function indexcheckout(){
    //     $LoaiGiay = LoaiGiay::all();
    //     return view('checkout',['LoaiGiay'=>$LoaiGiay]);
    // }
